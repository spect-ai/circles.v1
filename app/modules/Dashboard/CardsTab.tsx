import { CircleType, ProjectType, UserType, CardDetails } from "@/app/types";
...
function groupByCircles(currentUser: UserType, id: string) {
  const res = Object.values(currentUser.cardDetails)?.filter(
    (card: any) => {
...
function YourCards({
  ...
  console.log(currentUser.cardDetails);
  return (
    <ScrollContainer>
      <Row>
        {!isLoading &&
