...
export default function TemplateModal({ handleClose, setLoading }: Props) {
  ...
  return (
    <Modal handleClose={() => handleClose(false)} title="Use Template">
      <Box padding={"8"}>
        ...
        <Box paddingY={"6"}>
          <Stack direction={"vertical"} space="5" align={"center"}>
            {step == 0 && (
              <>
                <Text align={"center"}>
                  Would you like to connect discord ?
                </Text>
                <Text align={"center"}>
                  Just a few clicks and the grantees will have a discord role,
                  every grants project will have a channel in your discord
                  server
                </Text>
            ...
            {step == 1 && (
              <>
                ...
                <Text align={"center"}>
                  Would you like to create a channel for each grant project
                  which has been accepted ? If yes, please select a channel
                  category
                </Text>
                <Dropdown
