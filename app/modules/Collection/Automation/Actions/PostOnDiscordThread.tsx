...
const PostCardOnDiscordThread = ({ setAction, action, collection }: Props) => {
  const { origin } = useLocation();
  const [, setChannelOptions] = useState<Option[]>([]);
  const [selectedChannel] = useState<Option>(action?.data?.channel || {});
...
export default PostCardOnDiscordThread;
