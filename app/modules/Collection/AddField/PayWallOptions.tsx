...
interface Props {
  ...
  setPayWallOption: (opt: PayWallOptions) => void;
}
const PayWall = ({ payWallOption, setPayWallOption }: Props) => {
    ...
    <Box>
      <Stack space="4">
        ...
        <RewardTokenOptions
          ...
          customText="Pick the network and token that the payer can pay with"
