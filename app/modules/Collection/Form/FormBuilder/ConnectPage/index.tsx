...
import { Box, Spinner, Stack, useTheme } from "degen";
          ...
          >
            ...
            {form.formMetadata.sybilProtectionEnabled && (
              ...
              >
                ...
                <Stack space="1">
                  <Text>
                    This form is sybil protected using Gitcoin Passport. You
                    must have a minimum score of 100% to fill this form.
                  </Text>
                  <Box
                    display="flex"
                    flexDirection="row"
                ...
                {!currentUser && (
                  <Stack space="2">
                    <Text>
                      Please sign in to verify your Gitcoin passport. Make sure
                      to connect the same account that contains your stamps.
                    </Text>
                  </Stack>
                )}
                {!loadingPassport && currentUser && (
                  <Box>
                    ...
                    <StampScrollContainer>
                      {stamps?.map(
                        (
                          stamp: StampWithScoreAndVerification,
                          index: number
                        ) => {
                          return (
                            <StampCard mode={mode} key={index}>
                              ...
                              >
                                ...
                                {stamp.verified && <Tag>Verified</Tag>}
